...
#     min_val = np.min(image_paded.ravel())
#     max_val = np.max(image_paded.ravel())
#     img_paded = 1.0*(image_paded - min_val) / (max_val - min_val)
    
    image_paded = image_paded / 255.
    #image_paded = exposure.adjust_gamma(image_paded, 0.8)
    if gt_boxes is None:
        return image_paded
