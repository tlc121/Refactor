...
def dense264(input_, trainable):
    ...
    input_ = denseblock(input_, 36, 32, trainable= self.trainable, name='Denseblock3')

    input_ = transition_block(input_, 32, trainable= self.trainable, name='Transision3')
    
    route_3 = input_

    input_ = denseblock(input_, 24, 32, trainable= self.trainable, name='Denseblock4')
