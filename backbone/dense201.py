...
def dense201(input_, trainable):
    ...
    input_ = denseblock(input_, 48, 32, trainable= trainable, name='Denseblock3')

    input_ = transition_block(input_, 32, trainable= trainable, name='Transision3')
    
    route_3 = input_

    input_ = denseblock(input_, 32, 32, trainable= trainable, name='Denseblock4')

    input_ = Batch_Norm(input_, 'batchnorm', trainable)
