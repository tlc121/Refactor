...
from backbone import res34, res50, res101, res18, MobileNet_V1, MobileNet_V2, Efficient_b0
...
class Efficient(object):
    ...
    def build_network(self):
        with tf.variable_scope('backbone'):
            _, _, _, _, _, _, input_ = Efficient_b0.Efficient_B0(self.input_data, self.trainable)
